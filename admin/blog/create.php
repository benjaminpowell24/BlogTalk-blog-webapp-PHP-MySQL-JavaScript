                            ...
                            <form action="create.php" method="POST" enctype="multipart/form-data">
                                ...
                                <div class="row">
                                    <div class="col mx-auto">
                                        ...
                                        <div class="image-area"><img src="#" alt="" id="imageResult" class="img-fluid rounded shadow-sm mx-auto d-block" style="width: 400px;"></div>
                                    </div>
                                </div>
                                ...
                                <div>
                                    ...
                                    <?php
                                     $query = "SELECT tname FROM topics WHERE deleted=0;";
